...
def main(dim):
    ...
    for i in range(len(CEC2014Funcs)):
        ...
        for j in range(Trials):
            ...
            Trace = ESHHA(CEC2014Funcs[i])
            All_Trial_Best.append(Trace)
        np.savetxt("./ES-HHA_Data/CEC2014/F" + str(i + 1) + "_" + str(dim) + "D.csv", All_Trial_Best, delimiter=",")


if __name__ == "__main__":
    if os.path.exists('ES-HHA_Data/CEC2014') == False:
        os.makedirs('ES-HHA_Data/CEC2014')
    Dims = [30]
    for dim in Dims:
        main(dim)
